...
var playerData ={
	info:{
		src:`images/rotospritesheet.png`
	},
	states:{
		//The idle animation 
    	idle:
		{
			...
			frames:
			[
				{width:512, height:512, startX:3060, startY:0},
				{width:512, height:512, startX:3578, startY:0},
				{width:512, height:512, startX:4090, startY:0}
		...
		walk:
		{
			...
			[
				...
				{width:512, height:512, startX:512*2, startY:0},
				{width:512, height:512, startX:512, startY:0},
		...
		jump:
		{
			...
			frames:
			[
				{width:512, height:512, startX:512*4, startY:0}
			]
		},
		...
		crouch:
		{
			...
			frames:
			[
				{width:512, height:512, startX:512*5, startY:0},
		...
		attack:
		{
			...
			frames:
			[
				{width:512, height:512, startX:512*3, startY:0},
